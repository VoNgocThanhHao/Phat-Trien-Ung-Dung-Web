...
@section('content')
    ...
    <section class="content-header" style="padding-top: 5rem;">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Cảm ơn bạn đã mua hàng tại Điện máy Đen</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3" style="background-color: rgba(255,255,255,0.1); border-radius: 10px">
                        ...
                        <div class="row no-print">
                            <div class="col-12">
{{--                                <a href="javascript:history.go(-3)" rel="noopener" class="btn btn-default"> Trở về</a>--}}
                                <a href="{{ route('home') }}" class="btn btn-success float-right"><i class="far fa-credit-card"></i>
                                    Xác nhận
                                </a>
