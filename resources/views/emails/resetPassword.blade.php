                    ...
                    <table style="border-spacing:0;" width="100%">
                        ...
                        <tr>
                            <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                                <center>
                                    <p class="description center" style="font-family:'Muli','Arial Narrow',Arial;Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;Margin-bottom:10px;margin-left: auto; margin-right: auto;"><span style="color: rgb(161, 168, 173); font-size: 20px; text-align: center; background-color: rgb(255, 255, 255);">Sử dụng code phía dưới để đặt lại mật khẩu cho tài khoản của bạn!</span></p>

                                    <p class="h1 center" style="Margin:0;text-align:center;font-family:'flama-condensed','Arial Narrow',Arial;font-weight:100;font-size:30px;Margin-bottom:26px;Margin-top:26px; background-color: black; color: white;">
                                           <strong>{{ $code }}</strong>
                                    </p>
                                    <!--[if (gte mso 9)|(IE)]><![endif]-->

                                    <p class="description center" style="font-family:'Muli','Arial Narrow',Arial;Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;Margin-bottom:10px;margin-left: auto; margin-right: auto;"><span style="color: rgb(161, 168, 173); font-size: 15px; text-align: center; background-color: rgb(255, 255, 255);"><b>Lưu ý: Mã chỉ có tác dụng trong 10 phút.</b></span></p>
