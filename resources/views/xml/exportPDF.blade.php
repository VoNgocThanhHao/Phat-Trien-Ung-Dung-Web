            ...
            <div class="col-12">
                ...
                <div class="invoice p-3 mb-3" style="background-color: rgba(255,255,255,0.1); border-radius: 10px">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4>
                                <img src="{{asset("public/mySource/imgs/logo/logo_v2.png")}}"
                                     style="border-radius: 50%; width: 40px"> Điện máy Đen
                                <small class="float-right">Ngày lập hóa
                                    đơn: {{ $bill->created_at->format('d-m-Y') }}</small>
                            </h4>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($bill->order as $key => $order)
                                    <tr>
                                        ...
                                        <td>{{ number_format($order->product->price * $order->quantity, 0 ,"," ,".") }}
                                            VND
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <div class="col-6">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Giảm giá:</th>
                                        <td>{{ $bill->type == 0 ? '0 %' : '5 % (Thanh toán VNPay)' }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>Tổng cộng:</th>
                                        <td>{{ $bill->type == 0 ? number_format($total, 0 ,"," ,".") : number_format(($total - $total*5/100), 0 ,"," ,".") }}
                                            VND
                                        </td>
                                    </tr>
                                    </tbody>
